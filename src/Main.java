...
public class Main {
    public static void main(String[] args) {
        ...
        Stream<Integer> fib = SequenceSupplier.RecurrenceStream(coefs, initial);
        fib.limit(10).map(x -> x.toString() + " ").forEach(System.out::print);

        System.out.println("\n\nFibonacci sequence (from 20th element): ");
        coefs = new int[]{1, 1};
        initial = new int[]{1, 0};
        fib = SequenceSupplier.RecurrenceStream(coefs, initial, 20);
        fib.limit(10).map(x -> x.toString() + " ").forEach(System.out::print);
        ...
        Stream<Integer> rec = SequenceSupplier.RecurrenceStream(coefs, initial);
